...
export var FULL_EXTENDS_DIRECTIONS = [
    { x: -1, y: 0 },
    { x: -1, y: -1 },
    { x: 0, y: -1 },
    { x: 1, y: -1 },
...
export var FULL_CROSS_DIRECTIONS = [
    { x: -1, y: 0 },
    { x: 0, y: -1 },
    { x: 1, y: 0 },
    { x: 0, y: 1 },
];
export var OnRoadEvents = [
    {
