...
//const checkScreen = (w, h, cw, ch) => w !== cw || h !== ch;
//const randomRange = (m, x) => Math.random() * (x - m) + m;
  ...
  constructor(vue) {
    ...
    /*  Store.subscribe(() => {
        const {
          ...
          canvasWidth,
          canvasHeight
        } = Store.getState().pixiUitl.Renderer;
