  ...
  <section id="indexbox" class="container indexcolor">
    ...
    <div class="toplayer">
      ...
      <div class="box-wrap" v-if="step===0">
        <nuxt-link to="#gamestart" class="box" @click.native="mineField">
          <p>Sexy Mines</p>
        </nuxt-link>
      ...
      <div class="box-wrap" v-else-if="step===4">
        <mine-game-instructions @back="step=0"/>
      </div>
...
<script>
  ...
  import MineGameInstructions from "../components/minefield/MineGameInstructions";

  export default {
    mixins : [soundbase, sndff],
    components : {
      MineGameInstructions,
      LoginMiniGames,
      Bg_psx,
      GameResults,
      Bg_movingcity,
