<template>
  <div class="night">
    <div :key="nqc" v-for="(t, nqc) in star_count" class="shooting_star"></div>
  </div>
</template>
<script>
  export default {
    name : "bg_shootingstar",
    data () {
      return {
        star_count : []
      }
...
<style scoped lang="scss">
  ...
  $background_start_color: rgb(105, 255, 250);
  $background_shadow_color: rgb(255, 237, 61);
